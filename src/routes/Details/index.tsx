...
import { MoviePosterImage, Button } from '../../components';
import { addFavorite, removeFavoriteButton } from '../../store/reducer';
		...
		<div style={wrapperStyle}>
			<div style={detailsContainerStyle}>
				...
				<div>	
					...
					<Button id={"favorite-button"} label={"Adicionar aos Favoritos"} backgroundColor={"green"} color={"white"} onClick={() => dispatch(addFavorite(favoriteInfo))}>
